...
#include "param_config_manager.h"
...
using avos::common::config::ModelConfigFileListProto;
using avos::common::config::MultiModelConfigProto;
using avos::common::config::ModelConfigProto;
...
bool ParamConfigManager::ModuleConfigLoad(const std::string &adapter_config_filename) {
  ...
  MultiModelConfigProto multi_model_config_proto;
  if (!TextFormat::ParseFromString(content,
                                   &multi_model_config_proto)) {
    cout << "invalid MultiModelConfigProto file: " << content << endl;
    return false;
  }

  // cout << "multi_model_config_proto.model_configs() : " << multi_model_config_proto.model_configs_size() << endl;
...
bool ParamConfigManager::SetModelConfig(const std::string& model_name,
...
bool ParamConfigManager::GetModelConfig(const std::string& model_name,
                                        ModelConfig** model_config)
{
  if (!inited_ ) {
