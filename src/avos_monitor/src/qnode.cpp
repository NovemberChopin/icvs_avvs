...
{
//    读取topic的设置
    QSettings topic_setting("topic_setting","avos_monitor");
...
bool QNode::init()
{
    ros::init(init_argc, init_argv, "avos_monitor");
    if ( ! ros::master::check() )
    {
        return false;
    }
...
bool QNode::init(const std::string &master_url, const std::string &host_url)
{
    ...
    ros::init(remappings,"avos_monitor");
    if ( ! ros::master::check() )
    {
        return false;
    }
