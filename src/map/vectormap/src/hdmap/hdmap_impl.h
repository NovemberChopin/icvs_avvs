...
class HDMapImpl {
 ...
 public:
   ...
   * @return 0:success, otherwise failed
   */
  int GetJunctions(const avos::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetStopSigns(const avos::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetYieldSigns(const avos::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetClearAreas(const avos::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise failed
   */
  int GetSpeedBumps(const avos::common::PointENU& point, double distance,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetNearestLaneWithHeading(const avos::common::PointENU& point,
   ...
   * @return 0:success, otherwise, failed.
   */
  int GetLanesWithHeading(const avos::common::PointENU& point,
   ...
   * @return 0:success, otherwise failed
   */
  int GetRoadBoundaries(const avos::common::PointENU& point, double radius,
                        std::vector<RoadROIBoundaryPtr>* road_boundaries,
                        std::vector<JunctionBoundaryPtr>* junctions) const;
  /**
   * @brief get forward nearest my_signals within certain range on the lane
   *        if there are two my_signals related to one stop line,
   *        return both my_signals.
   * @param point the target position
   * @param distance the forward search distance
   * @param my_signals all my_signals match conditions
   * @return 0:success, otherwise failed
   */
  int GetForwardNearestSignalsOnLane(
      const avos::common::PointENU& point, const double distance,
      std::vector<SignalInfoConstPtr>* my_signals) const;
 ...
 private:
  int GetLanes(const avos::common::math::Vec2d& point, double distance,
               std::vector<LaneInfoConstPtr>* lanes) const;
  int GetJunctions(const avos::common::math::Vec2d& point, double distance,
                   std::vector<JunctionInfoConstPtr>* junctions) const;
  int GetCrosswalks(const avos::common::math::Vec2d& point, double distance,
                    std::vector<CrosswalkInfoConstPtr>* crosswalks) const;
  int GetSignals(const avos::common::math::Vec2d& point, double distance,
                 std::vector<SignalInfoConstPtr>* my_signals) const;
  int GetStopSigns(const avos::common::math::Vec2d& point, double distance,
                   std::vector<StopSignInfoConstPtr>* stop_signs) const;
  int GetYieldSigns(const avos::common::math::Vec2d& point, double distance,
                    std::vector<YieldSignInfoConstPtr>* yield_signs) const;
  int GetClearAreas(const avos::common::math::Vec2d& point, double distance,
                    std::vector<ClearAreaInfoConstPtr>* clear_areas) const;
  int GetSpeedBumps(const avos::common::math::Vec2d& point, double distance,
                    std::vector<SpeedBumpInfoConstPtr>* speed_bumps) const;
  int GetNearestLane(const avos::common::math::Vec2d& point,
                     LaneInfoConstPtr* nearest_lane, double* nearest_s,
                     double* nearest_l) const;
  int GetNearestLaneWithHeading(const avos::common::math::Vec2d& point,
                                const double distance,
                                const double central_heading,
                                const double max_heading_difference,
                                LaneInfoConstPtr* nearest_lane,
                                double* nearest_s, double* nearest_l) const;
  int GetLanesWithHeading(const avos::common::math::Vec2d& point,
                          const double distance, const double central_heading,
                          const double max_heading_difference,
                          std::vector<LaneInfoConstPtr>* lanes) const;
  int GetRoads(const avos::common::math::Vec2d& point, double distance,
               std::vector<RoadInfoConstPtr>* roads) const;

  template <class Table, class BoxTable, class KDTree>
  static void BuildSegmentKDTree(
      const Table& table, const avos::common::math::AABoxKDTreeParams& params,
  ...
  static int SearchObjects(const avos::common::math::Vec2d& center,
