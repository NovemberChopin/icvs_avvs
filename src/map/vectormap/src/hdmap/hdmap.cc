...
int HDMap::GetLanes(const avos::common::PointENU& point, double distance,
                    std::vector<LaneInfoConstPtr>* lanes) const {
  return impl_.GetLanes(point, distance, lanes);
}

int HDMap::GetJunctions(const avos::common::PointENU& point, double distance,
                        std::vector<JunctionInfoConstPtr>* junctions) const {
  return impl_.GetJunctions(point, distance, junctions);
}

int HDMap::GetSignals(const avos::common::PointENU& point, double distance,
                      std::vector<SignalInfoConstPtr>* my_signals) const {
  return impl_.GetSignals(point, distance, my_signals);
}

int HDMap::GetCrosswalks(const avos::common::PointENU& point, double distance,
                         std::vector<CrosswalkInfoConstPtr>* crosswalks) const {
  return impl_.GetCrosswalks(point, distance, crosswalks);
}

int HDMap::GetStopSigns(const avos::common::PointENU& point, double distance,
...
int HDMap::GetYieldSigns(
    const avos::common::PointENU& point, double distance,
...
int HDMap::GetRoads(const avos::common::PointENU& point, double distance,
...
int HDMap::GetNearestLaneWithHeading(const avos::common::PointENU& point,
...
int HDMap::GetLanesWithHeading(const avos::common::PointENU& point,
                               const double distance,
                               const double central_heading,
                               const double max_heading_difference,
                               std::vector<LaneInfoConstPtr>* lanes) const {
...
int HDMap::GetRoadBoundaries(
    const avos::common::PointENU& point, double radius,
...
int HDMap::GetForwardNearestSignalsOnLane(
    ...
    std::vector<SignalInfoConstPtr>* my_signals) const {
  return impl_.GetForwardNearestSignalsOnLane(point, distance, my_signals);
}
