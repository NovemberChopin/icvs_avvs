...
class ObjectWithAABox {
 public:
  ObjectWithAABox(const avos::common::math::AABox2d &aabox,
                  const Object *object, const GeoObject *geo_object,
                  const int id)
      : aabox_(aabox), object_(object), geo_object_(geo_object), id_(id) {}
  ~ObjectWithAABox() {}
  const avos::common::math::AABox2d &aabox() const { return aabox_; }
  double DistanceTo(const avos::common::math::Vec2d &point) const {
    return geo_object_->DistanceTo(point);
  }
  double DistanceSquareTo(const avos::common::math::Vec2d &point) const {
 ...
 private:
  avos::common::math::AABox2d aabox_;
...
using LaneSegmentBox =
    ObjectWithAABox<LaneInfo, avos::common::math::LineSegment2d>;
using LaneSegmentKDTree = avos::common::math::AABoxKDTree2d<LaneSegmentBox>;
...
class LaneInfo {
 public:
  ...
  const std::vector<avos::common::math::Vec2d> &points() const {
    return points_;
  }
  const std::vector<avos::common::math::Vec2d> &unit_directions() const {
  ...
  const std::vector<avos::common::math::LineSegment2d> &segments() const {
    return segments_;
  }
  ...
  const std::vector<OverlapInfoConstPtr> &my_signals() const { return signals_; }
  ...
  bool IsOnLane(const avos::common::math::Vec2d &point) const;
  bool IsOnLane(const avos::common::math::Box2d &box) const;

  avos::common::PointENU GetSmoothPoint(double s) const;
  double DistanceTo(const avos::common::math::Vec2d &point) const;
  double DistanceTo(const avos::common::math::Vec2d &point,
                    avos::common::math::Vec2d *map_point, double *s_offset,
                    int *s_offset_index) const;
  avos::common::PointENU GetNearestPoint(
      const avos::common::math::Vec2d &point, double *distance) const;
  bool GetProjection(const avos::common::math::Vec2d &point,
 ...
 private:
  ...
  int PathDensify(std::vector<avos::common::math::Vec2d> &points_init, 
        std::vector<avos::common::math::Vec2d> &points_out, 
        const double density);

 private:
  const Lane &lane_;
  std::vector<avos::common::math::Vec2d> points_;
  std::vector<avos::common::math::Vec2d> unit_directions_;
  std::vector<double> headings_;
  std::vector<avos::common::math::LineSegment2d> segments_;
...
class JunctionInfo {
 public:
  ...
  const avos::common::math::Polygon2d &polygon() const { return polygon_; }
 ...
 private:
  ...
  avos::common::math::Polygon2d polygon_;

  std::vector<Id> overlap_stop_sign_ids_;
  std::vector<Id> overlap_ids_;
};
using JunctionPolygonBox =
    ObjectWithAABox<JunctionInfo, avos::common::math::Polygon2d>;
using JunctionPolygonKDTree =
    avos::common::math::AABoxKDTree2d<JunctionPolygonBox>;
...
using SignalSegmentBox =
    ObjectWithAABox<SignalInfo, avos::common::math::LineSegment2d>;
using SignalSegmentKDTree =
    avos::common::math::AABoxKDTree2d<SignalSegmentBox>;
...
using CrosswalkPolygonBox =
    ObjectWithAABox<CrosswalkInfo, avos::common::math::Polygon2d>;
using CrosswalkPolygonKDTree =
    avos::common::math::AABoxKDTree2d<CrosswalkPolygonBox>;
...
using StopSignSegmentBox =
    ObjectWithAABox<StopSignInfo, avos::common::math::LineSegment2d>;
using StopSignSegmentKDTree =
    avos::common::math::AABoxKDTree2d<StopSignSegmentBox>;
...
using YieldSignSegmentBox =
    ObjectWithAABox<YieldSignInfo, avos::common::math::LineSegment2d>;
using YieldSignSegmentKDTree =
    avos::common::math::AABoxKDTree2d<YieldSignSegmentBox>;
...
using ClearAreaPolygonBox =
    ObjectWithAABox<ClearAreaInfo, avos::common::math::Polygon2d>;
using ClearAreaPolygonKDTree =
    avos::common::math::AABoxKDTree2d<ClearAreaPolygonBox>;
...
using SpeedBumpSegmentBox =
    ObjectWithAABox<SpeedBumpInfo, avos::common::math::LineSegment2d>;
using SpeedBumpSegmentKDTree =
    avos::common::math::AABoxKDTree2d<SpeedBumpSegmentBox>;
