...
class BaseMap {
 public:
  BaseMap(std::string map_dir, avos::map::mpHeader &config);
  ///////////////////////////////////////////
  ...
  bool IsInFreespace(const avos::vectormap::PointGCCS &car_pgccs, 
      const avos::vectormap::PointVCS &target_pvcs);
  FunctionType GetFunctionType(const avos::vectormap::PointGCCS &car_pgccs, 
      const avos::vectormap::PointVCS &target_pvcs);
  LocValue GetLocValue(const avos::vectormap::PointGCCS &car_pgccs, 
      const avos::vectormap::PointVCS &target_pvcs);
  ...
  DTGProto GetDistanceTransformGraphProto(
      const avos::vectormap::PointGCCS &car_pgccs, 
      const avos::vectormap::PointVCS &target_pvcs = {0, 0, 0});
